...
import { type NetworkConfig, config } from "../lib/config";
		...
		case "networkSwitched": {
			...
			const status =
				networkId === process.env.NEXT_PUBLIC_NETWORK_ID
					? "idle"
					: "wrongNetwork";
			const networkConfig = status === "idle" ? config[networkId] : null;
			const newState = { ...state, status, networkId, networkConfig };
